    ...
    render(){
        return(
            <div className={'h-28 w-28 ' + this.props.className}>
                ...
                <div className='border rounded-2xl border-transparentgray w-full h-full cursor-pointer bg-white overflow-hidden' onClick={this.handleClick}><img className='object-cover h-full w-full' ref={this.previewImage}/></div>
            </div>
        );
    }
}
